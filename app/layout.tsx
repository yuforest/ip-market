        ...
        <footer className="border-t py-6 md:py-10">
          <div className="container px-4 md:px-6">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div>
                <h3 className="text-lg font-bold mb-4">NFT IP Market</h3>
                <p className="text-sm text-gray-500">
                  Japan's first digital IP M&A marketplace. A platform where you
                  can buy and sell entire NFT collections.
                </p>
              </div>
              <div>
                <h3 className="text-sm font-bold mb-4">Links</h3>
